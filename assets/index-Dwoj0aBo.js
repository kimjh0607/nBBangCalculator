(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}})();function O(e,t){const n={};e.forEach(o=>{n[o.id]=0});const a={};e.forEach(o=>{a[o.id]={},t.forEach(l=>{a[o.id][l.id]=null})});const i={};e.forEach(o=>{i[o.id]=[]}),t.forEach(o=>{const l=e.filter(u=>o.participantIds.includes(u.id));if(l.length===0)return;let c={};if(o.splitDrink){const u=o.foodAmount||0,f=o.drinkAmount||0,v=o.beverageAmount||0,p=o.drinkerIds||[],h=o.beveragerIds||[],_=o.noFoodIds||[],x=l.filter(k=>!_.includes(k.id)).length,A=l.filter(k=>p.includes(k.id)).length,R=l.filter(k=>h.includes(k.id)).length,S=x>0?u/x:0,L=A>0?f/A:0,T=R>0?v/R:0;l.forEach(k=>{let E=0;_.includes(k.id)||(E+=S),p.includes(k.id)?E+=L:h.includes(k.id)&&(E+=T),c[k.id]=E})}else{const u=o.totalAmount||0,f=l.length>0?u/l.length:0;l.forEach(v=>{c[v.id]=f})}Object.keys(c).forEach(u=>{c[u]=B(c[u])}),l.forEach(u=>{a[u.id][o.id]=c[u.id]});const m=o.splitDrink?(o.foodAmount||0)+(o.drinkAmount||0)+(o.beverageAmount||0):o.totalAmount||0;l.forEach(u=>{u.id===o.payerId?n[u.id]+=m-c[u.id]:n[u.id]-=c[u.id]})}),e.forEach(o=>{const l=t.filter(p=>p.splitDrink&&p.participantIds.includes(o.id));if(l.length===0)return;const c=[],m=[],u=[],f=[];l.forEach(p=>{const h=(p.drinkerIds||[]).includes(o.id),_=(p.beveragerIds||[]).includes(o.id),x=(p.noFoodIds||[]).includes(o.id);x&&!h&&!_?c.push(p):_?m.push(p):!h&&!_?u.push(p):h&&x&&f.push(p)});const v=(p,h,_)=>_?h:`${p.map(x=>x.name||`${x.id}차`).join("·")} ${h}`;c.length>0&&i[o.id].push(v(c,"참석만",c.length===l.length)),m.length>0&&i[o.id].push(v(m,"음료",m.length===l.length)),u.length>0&&i[o.id].push(v(u,"비음주",u.length===l.length)),f.length>0&&i[o.id].push(v(f,"음식X",f.length===l.length))});const r={};e.forEach(o=>{let l=0;t.forEach(c=>{const m=a[o.id][c.id];m!==null&&(l+=m)}),r[o.id]=l});const d=j(n,e);return{matrix:a,totals:r,notes:i,transfers:d}}function j(e,t){const n=[],a={};t.forEach(d=>{a[d.id]=d.name});let i=[],r=[];for(Object.keys(e).forEach(d=>{const o=B(e[d]);o>0?i.push({id:d,amount:o}):o<0&&r.push({id:d,amount:Math.abs(o)})}),i.sort((d,o)=>o.amount-d.amount),r.sort((d,o)=>o.amount-d.amount);i.length>0&&r.length>0;){const d=i[0],o=r[0],l=Math.min(d.amount,o.amount);l>0&&n.push({from:a[o.id],fromId:o.id,to:a[d.id],toId:d.id,amount:B(l)}),d.amount-=l,o.amount-=l,d.amount<=0&&i.shift(),o.amount<=0&&r.shift()}return n}function B(e){return Math.round(e/100)*100}function $(e){return e==null?"-":e.toLocaleString("ko-KR")+"원"}const F={"004":"국민","088":"신한","020":"우리","081":"하나","011":"농협","003":"기업","023":"SC제일","032":"부산","034":"광주","031":"대구","037":"전북","035":"제주","007":"수협","002":"산업","045":"새마을금고","048":"신협","089":"케이뱅크","090":"카카오뱅크","092":"토스뱅크"};function P(e,t,n,a={}){const{transfers:i}=n,r=[];return i.length===0?(r.push("✅ 모두 정산 완료!"),r.join(`
`)):(r.push("💸 송금 안내"),[...new Set(i.map(o=>o.toId))].forEach(o=>{const l=e.find(f=>f.id===o);if(!l)return;const c=a[o]||{},m=F[c.bankCode]||"",u=m&&c.accountNumber;r.push(""),r.push(`📌 ${l.name}에게 보내주세요`),u&&r.push(`💳 ${m} ${c.accountNumber}`),i.filter(f=>f.toId===o).forEach(f=>{const v=u?`supertoss://send?bank=${c.bankCode}&accountNumber=${encodeURIComponent(c.accountNumber)}&amount=${f.amount}&originName=${encodeURIComponent(f.to)}`:"";r.push(`  ${f.from} → ${$(f.amount)}`),v&&r.push(`  👉 ${v}`)})}),r.join(`
`))}const w=[{code:"090",name:"카카오뱅크"},{code:"092",name:"토스뱅크"},{code:"089",name:"케이뱅크"},{code:"004",name:"국민"},{code:"088",name:"신한"},{code:"020",name:"우리"},{code:"081",name:"하나"},{code:"011",name:"농협"},{code:"003",name:"기업"},{code:"023",name:"SC제일"},{code:"032",name:"부산"},{code:"034",name:"광주"},{code:"031",name:"대구"},{code:"037",name:"전북"},{code:"035",name:"제주"},{code:"007",name:"수협"},{code:"002",name:"산업"},{code:"045",name:"새마을금고"},{code:"048",name:"신협"}];let s={meetingName:"",meetingDate:new Date().toISOString().split("T")[0],payerBankInfos:{},participants:[],rounds:[],result:null,nextParticipantId:1,nextRoundId:1},N=!1;function q(){return`p${s.nextParticipantId++}`}function H(){return s.nextRoundId++}function b(){try{localStorage.setItem("splitEasy_state",JSON.stringify(s))}catch{}}function M(){try{const e=localStorage.getItem("splitEasy_state");if(e){const t=JSON.parse(e);s={...s,...t},s.payerBankInfos&&Object.keys(s.payerBankInfos).forEach(n=>{typeof s.payerBankInfos[n]=="string"&&(s.payerBankInfos[n]={bankCode:"",accountNumber:s.payerBankInfos[n]})})}}catch{}}function U(){localStorage.removeItem("splitEasy_state"),s={meetingName:"",meetingDate:new Date().toISOString().split("T")[0],payerBankInfos:{},participants:[],rounds:[],result:null,nextParticipantId:1,nextRoundId:1},y()}function I(e,t="success"){const n=document.getElementById("toast-container"),a=document.createElement("div");a.className=`toast toast--${t}`,a.innerHTML=`
    <i data-lucide="${t==="success"?"check-circle":"info"}"></i>
    <span>${e}</span>
  `,n.appendChild(a),lucide.createIcons({nodes:[a]}),setTimeout(()=>{a.style.animation="toastOut 300ms ease-out forwards",setTimeout(()=>a.remove(),300)},2e3)}function C(){const t=document.getElementById("participant-input").value.trim();if(t){if(s.participants.some(n=>n.name===t)){I("이미 추가된 이름입니다","info");return}s.participants.push({id:q(),name:t}),s.result=null,b(),y(),document.getElementById("participant-input").focus()}}function z(e){s.participants=s.participants.filter(t=>t.id!==e),s.rounds.forEach(t=>{t.participantIds=t.participantIds.filter(n=>n!==e),t.drinkerIds=(t.drinkerIds||[]).filter(n=>n!==e),t.beveragerIds=(t.beveragerIds||[]).filter(n=>n!==e),t.noFoodIds=(t.noFoodIds||[]).filter(n=>n!==e),t.payerId===e&&(t.payerId=null)}),s.result=null,b(),y()}function K(e,t){const n=s.rounds.find(r=>r.id===e);if(!n)return;n.drinkerIds||(n.drinkerIds=[]),n.beveragerIds||(n.beveragerIds=[]);const a=n.drinkerIds.includes(t),i=n.beveragerIds.includes(t);a?(n.drinkerIds=n.drinkerIds.filter(r=>r!==t),n.beveragerIds.push(t)):i?n.beveragerIds=n.beveragerIds.filter(r=>r!==t):n.drinkerIds.push(t),s.result=null,b(),y()}function X(){const e=H(),t=s.rounds.length+1,n=s.rounds[s.rounds.length-1],a=n?[...n.participantIds]:s.participants.map(i=>i.id);s.rounds.push({id:e,name:`${t}차`,totalAmount:0,foodAmount:0,drinkAmount:0,beverageAmount:0,splitDrink:!1,payerId:s.participants.length>0?s.participants[0].id:null,participantIds:a,drinkerIds:[...a],beveragerIds:[],receiptItems:[],nextReceiptItemId:1,noFoodIds:[]}),s.result=null,b(),y(),setTimeout(()=>{const i=document.querySelectorAll(".round-card"),r=i[i.length-1];r&&r.scrollIntoView({behavior:"smooth",block:"center"})},100)}function J(e,t){const n=s.rounds.find(i=>i.id===e);if(!n)return;n.noFoodIds||(n.noFoodIds=[]);const a=n.noFoodIds.indexOf(t);a>=0?n.noFoodIds.splice(a,1):n.noFoodIds.push(t),s.result=null,b(),y()}function V(e){const t=s.rounds.find(n=>n.id===e);t&&(t.receiptItems||(t.receiptItems=[]),t.nextReceiptItemId||(t.nextReceiptItemId=1),t.receiptItems.push({id:t.nextReceiptItemId++,name:"",quantity:1,unitPrice:0}),b(),y())}function W(e,t){const n=s.rounds.find(a=>a.id===e);n&&(n.receiptItems=(n.receiptItems||[]).filter(a=>a.id!==parseInt(t)),b(),y())}function G(e,t,n,a){const i=s.rounds.find(d=>d.id===e);if(!i)return;const r=(i.receiptItems||[]).find(d=>d.id===parseInt(t));r&&(n==="quantity"||n==="unitPrice"?r[n]=parseInt(a)||0:r[n]=a,b())}function Q(e){s.rounds=s.rounds.filter(t=>t.id!==e),s.result=null,b(),y()}function D(e,t,n){const a=s.rounds.find(i=>i.id===e);a&&(t==="totalAmount"||t==="foodAmount"||t==="drinkAmount"||t==="beverageAmount"?a[t]=parseInt(n)||0:t==="splitDrink"?(a[t]=n,n&&a.totalAmount>0&&a.foodAmount===0?(a.foodAmount=a.totalAmount,a.totalAmount=0):!n&&a.foodAmount>0&&(a.totalAmount=a.foodAmount+a.drinkAmount,a.foodAmount=0,a.drinkAmount=0)):a[t]=n,s.result=null,b(),y())}function Y(e,t){const n=s.rounds.find(i=>i.id===e);if(!n)return;const a=n.participantIds.indexOf(t);a>=0?n.participantIds.splice(a,1):n.participantIds.push(t),s.result=null,b(),y()}function Z(){if(s.participants.length===0){I("참여자를 추가해주세요","info");return}if(s.rounds.length===0){I("차수를 추가해주세요","info");return}s.result=O(s.participants,s.rounds),b(),y(),setTimeout(()=>{const e=document.getElementById("result-section");e&&e.scrollIntoView({behavior:"smooth",block:"start"})},100)}function tt(){if(!s.result)return;const e=P(s.participants,s.rounds,s.result,s.payerBankInfos),t=s.meetingName?`📋 [${s.meetingName}] 정산 결과  ${s.meetingDate}

`:"";navigator.clipboard.writeText(t+e).then(()=>{I("클립보드에 복사되었습니다!")}).catch(()=>{const n=document.createElement("textarea");n.value=t+e,document.body.appendChild(n),n.select(),document.execCommand("copy"),n.remove(),I("클립보드에 복사되었습니다!")})}async function et(){if(!s.result)return;const e=P(s.participants,s.rounds,s.result,s.payerBankInfos),n=(s.meetingName?`📋 [${s.meetingName}] 정산 결과  ${s.meetingDate}

`:`📋 정산 결과  ${s.meetingDate}

`)+e;if(navigator.share){try{await navigator.share({text:n})}catch(d){d?.name!=="AbortError"&&(navigator.clipboard.writeText(n).catch(()=>{}),I("클립보드에 복사되었습니다!"))}return}const a=document.getElementById("share-result-btn"),i=a?.innerHTML;a&&(a.disabled=!0,a.innerHTML='<i data-lucide="loader-circle" style="width:16px;height:16px;animation:spin 1s linear infinite"></i> 준비 중...',lucide.createIcons({nodes:[a]}));let r=null;if(typeof html2canvas<"u"){const d=document.createElement("div");d.style.cssText="position:fixed;top:-9999px;left:-9999px;padding:24px;background:#0d1117;min-width:360px;";try{const o=document.getElementById("receipt-summary-section"),l=document.getElementById("result-section");if(await document.fonts.ready,o){const u=o.cloneNode(!0);u.style.animation="none",d.appendChild(u)}const c=l.cloneNode(!0);c.style.animation="none",d.appendChild(c),document.body.appendChild(d);const m=await html2canvas(d,{backgroundColor:"#0d1117",scale:2,useCORS:!0,logging:!1});r=await new Promise(u=>m.toBlob(u,"image/png"))}catch{}finally{d.parentNode&&document.body.removeChild(d)}}try{if(r)try{await navigator.clipboard.write([new ClipboardItem({"image/png":r})]),I("이미지가 클립보드에 복사됐어요! 채팅창에 붙여넣기하세요.")}catch{const o=URL.createObjectURL(r),l=document.createElement("a");l.href=o,l.download="정산결과.png",l.click(),URL.revokeObjectURL(o),I("이미지 저장됨! 채팅창에 파일로 첨부해주세요.")}else await navigator.clipboard.writeText(n),I("클립보드에 복사되었습니다!")}catch{navigator.clipboard.writeText(n).catch(()=>{}),I("클립보드에 복사되었습니다!")}finally{a&&i&&(a.disabled=!1,a.innerHTML=i,lucide.createIcons({nodes:[a]}))}}function y(){const e=document.getElementById("app");e.innerHTML=`
    ${nt()}
    ${at()}
    ${it()}
    ${ot()}
  ...
  `}function rt(e,t){const n=e.drinkerIds||[],a=e.beveragerIds||[],i=e.noFoodIds||[],r=s.participants.map(c=>{const m=e.participantIds.includes(c.id),u=n.includes(c.id),f=a.includes(c.id),v=u?"drinker":f?"beverage":"sober",p=u?"🍺":f?"🥤":"🚫",h=u?"음주":f?"음료":"없음";return`
      <label class="check-item ${m?"check-item--checked":""}"
        ...
        ${e.splitDrink&&m?`
          ...
          <span class="drink-toggle drink-toggle--${v}"
  ...
  `}function ut(){const{matrix:e,totals:t,notes:n}=s.result;let a='<table class="result-table"><thead><tr>';a+="<th>이름</th>",s.rounds.forEach(d=>{a+=`<th>${g(d.name)}</th>`}),a+="<th>총합</th></tr></thead><tbody>",s.participants.forEach(d=>{a+="<tr>",a+=`<td>${g(d.name)}</td>`,s.rounds.forEach(o=>{const l=e[d.id][o.id],c=o.payerId===d.id,m=bt(o,d.id);l===null?a+='<td class="not-participated">-</td>':c?a+=`<td class="amount payer-cell">${$(l)}<span class="payer-chip">결제</span>${m}</td>`:l===0?a+='<td><span class="attend-only-badge">참석만</span></td>':a+=`<td class="amount">${$(l)}${m}</td>`}),a+=`<td class="total-col amount">${$(t[d.id])}</td>`,a+="</tr>"}),a+="</tbody></table>";const{transfers:i}=s.result;let r="";return i.length===0?r='<div class="transfer-done"><i data-lucide="check-circle"></i> 모두 정산 완료!</div>':r='<div class="transfer-list">'+[...new Set(i.map(o=>o.toId))].map(o=>{const l=s.payerBankInfos[o]||{},c=w.find(p=>p.code===l.bankCode)?.name||"",m=c&&l.accountNumber,f=i.filter(p=>p.toId===o).map(p=>{const h=m?`supertoss://send?bank=${l.bankCode}&accountNumber=${encodeURIComponent(l.accountNumber)}&amount=${p.amount}&originName=${encodeURIComponent(p.to)}`:"";return`
          <div class="transfer-item__row">
            <span class="transfer-item__from">${g(p.from)}</span>
            <i data-lucide="arrow-right" style="width:14px;height:14px;color:var(--accent-primary);flex-shrink:0"></i>
            <span class="transfer-item__to">${g(p.to)}</span>
            <span class="transfer-item__amount amount">${$(p.amount)}</span>
            ${h?`<a href="${h}" class="btn-toss">토스 송금</a>`:""}
          </div>
        `}).join(""),v=m?`
      ...
      `:"";return`<div class="transfer-item">${f}${v}</div>`}).join("")+"</div>",`
  ...
  `}function pt(){const e=document.getElementById("participant-input");e&&e.addEventListener("keydown",c=>{c.key==="Enter"&&(c.preventDefault(),C())});const t=document.getElementById("add-participant-btn");t&&t.addEventListener("click",C);const n=document.getElementById("add-round-btn");n&&n.addEventListener("click",X);const a=document.getElementById("calculate-btn");a&&a.addEventListener("click",Z);const i=document.getElementById("copy-result-btn");i&&i.addEventListener("click",tt);const r=document.getElementById("share-result-btn");r&&r.addEventListener("click",et);const d=document.getElementById("reset-btn");d&&d.addEventListener("click",()=>{confirm("모든 데이터를 초기화할까요?")&&U()});const o=document.getElementById("meeting-name");o&&o.addEventListener("input",c=>{s.meetingName=c.target.value,b()});const l=document.getElementById("meeting-date");if(l&&l.addEventListener("input",c=>{s.meetingDate=c.target.value,b()}),!N){const c=document.getElementById("app");c.addEventListener("click",mt),c.addEventListener("change",ft),c.addEventListener("input",gt),c.addEventListener("blur",m=>{m.target.closest('[data-action="update-receipt-item"]')&&y()},!0),N=!0}}function mt(e){const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"remove-participant":z(t.dataset.id);break;case"toggle-food":e.preventDefault(),e.stopPropagation(),J(parseInt(t.dataset.round),t.dataset.participant);break;case"cycle-round-drink":e.preventDefault(),e.stopPropagation(),K(parseInt(t.dataset.round),t.dataset.participant);break;case"toggle-round-participant":e.preventDefault(),Y(parseInt(t.dataset.round),t.dataset.participant);break;case"remove-round":Q(parseInt(t.dataset.round));break;case"add-receipt-item":V(parseInt(t.dataset.round));break;case"remove-receipt-item":W(parseInt(t.dataset.round),t.dataset.item);break;case"copy-bank":{const a=t.dataset.bank;navigator.clipboard.writeText(a).then(()=>{I("계좌번호 복사됨!")}).catch(()=>{const i=document.createElement("textarea");i.value=a,document.body.appendChild(i),i.select(),document.execCommand("copy"),i.remove(),I("계좌번호 복사됨!")});break}}}function ft(e){const t=e.target.closest("[data-action]");if(!t)return;switch(t.dataset.action){case"toggle-split-drink":D(parseInt(t.dataset.round),"splitDrink",t.checked);break;case"update-round":t.tagName==="SELECT"&&D(parseInt(t.dataset.round),t.dataset.field,t.value);break;case"update-payer-bank-code":{const a=t.dataset.payer;s.payerBankInfos[a]||(s.payerBankInfos[a]={}),s.payerBankInfos[a].bankCode=t.value,b();break}}}function gt(e){const t=e.target.closest("[data-action]");if(t){if(t.dataset.action==="update-payer-bank-account"){const n=t.dataset.payer;s.payerBankInfos[n]||(s.payerBankInfos[n]={}),s.payerBankInfos[n].accountNumber=t.value.replace(/[^0-9]/g,""),b();return}if(t.dataset.action==="update-receipt-item"){G(parseInt(t.dataset.round),t.dataset.item,t.dataset.field,t.value);return}if(t.dataset.action==="update-round"){const n=s.rounds.find(i=>i.id===parseInt(t.dataset.round));if(!n)return;const a=t.dataset.field;a==="totalAmount"||a==="foodAmount"||a==="drinkAmount"||a==="beverageAmount"?n[a]=parseInt(t.value)||0:a==="name"&&(n[a]=t.value),s.result=null,b()}}}function bt(e,t){if(!e.splitDrink||!e.participantIds.includes(t))return"";const n=(e.drinkerIds||[]).includes(t),a=(e.beveragerIds||[]).includes(t),i=(e.noFoodIds||[]).includes(t);if(i&&!n&&!a)return"";const r=[];return a?r.push('<span class="cell-status-badge cell-status-badge--beverage">음료</span>'):n||r.push('<span class="cell-status-badge cell-status-badge--sober">비음주</span>'),i&&r.push('<span class="cell-status-badge cell-status-badge--nofood">음식X</span>'),r.length?`<br><span class="cell-status-badges">${r.join("")}</span>`:""}function g(e){return e?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}M();y();
